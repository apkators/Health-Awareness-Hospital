...
public class SignUpActivity extends AppCompatActivity {
    ...
    public void createuser() {
        pd.setTitle("Registering Hospital Please Wait...");
        pd.show();
        ...
        mAuth.createUserWithEmailAndPassword(m, p).addOnSuccessListener(SignUpActivity.this, authResult -> {
            Toast.makeText(SignUpActivity.this, "Hospital Registered", Toast.LENGTH_SHORT).show();
    ...
    public void writedata() {
        ...
        Hospital u = new Hospital(Email, id, Contact_Number, Name);
